    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                // Title
                Text("Delete Bang “\(bang.name)”?")
                    .font(.system(size: 18.5, weight: .bold))
                    .foregroundColor(foregroundPrimary)
                    .padding(.bottom, 6)

                // Subtitle
                Text("Are you sure you want to delete the search shortcut “!\(bang.cleanTrigger)”? You won’t be able to use this shortcut to search until you create it again.")
